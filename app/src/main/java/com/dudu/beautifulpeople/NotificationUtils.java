...
public class NotificationUtils {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "com.dudu.beautifulpeople.app";
    private static final String NOTIFICATION_CHANNEL_NAME = "com.dudu.beautifulpeople.app";
